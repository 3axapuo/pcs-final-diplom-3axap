...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (ServerSocket serverSocket = new ServerSocket(PORT)) { // стартуем сервер один(!) раз
            File[] foundFilesToSearch = searchFilesByFormat(LOCALDIR, "pdf"); // возможность выбрать каталог и расширение файла
    ...
    private static File[] searchFilesByFormat(String directoryAddress, String fileExtension) {
        try {
